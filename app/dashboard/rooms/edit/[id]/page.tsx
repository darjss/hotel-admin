...
export default function EditRoomPage() {
  ...
  const roomId = params.id ? parseInt(params.id as string, 10) : null
  const [roomData, setRoomData] = useState<any>(null) // Use a proper type for room data

  useEffect(() => {
    if (roomId) {
      // Replace with actual API call to fetch room data by ID
      const fetchedRoom = rooms.find((r) => r.id === roomId)
  ...
  return (
    <div className="p-6">
      <div className="mb-4 flex items-center gap-2">
        ...
        <h1 className="text-2xl font-semibold">Өрөө засварлах - #{roomId}</h1>
      </div>
      ...
      <div className="bg-white rounded-lg border border-[#f2f2f2] p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            {/* TODO: Implement image display and upload functionality */}
            <div className="text-center p-10 border border-dashed rounded-lg">
              Image editing not implemented yet.
            </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-4">
            <div>
              ...
              <Input placeholder="Өрөөний дугаар" className="w-full" defaultValue={roomData.roomNumber} />
            </div>
            <div>
              <Label className="mb-2 block">Өрөөний давхар *</Label>
              <Input placeholder="Давхарын дугаар" className="w-full" defaultValue={roomData.floor} />
            </div>
            <div>
